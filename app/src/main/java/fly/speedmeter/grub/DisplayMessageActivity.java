...
public class DisplayMessageActivity extends ActionBarActivity implements LocationListener, GpsStatus.Listener {
    ...
    public final static String EXTRA_MESSAGE = "something";
